  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md text-center border-2 border-gray-200">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-2">Step 5: Write JCDR</h1>
        <p className="text-gray-600 mt-2">Manuscript, tables, Word/PDF export. Use main Research flow.</p>
