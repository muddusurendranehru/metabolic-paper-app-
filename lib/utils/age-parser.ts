...
/** Parse age from string or null; returns number or null. Alias for callers passing string | null. */
export function parseAgeString(text: string | null): number | null {
  return text == null || text === "" ? null : parseAge(text);
}
